            ...
            <div class="flex">
                <div class="-ml-2 mr-2 flex items-center md:hidden">
                    ...
                    <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                        ...
                        -->
                        <h1 class="text-2xl font-bold leading-7 text-white sm:text-3xl sm:tracking-tight sm:truncate">
                            <img class="block lg:hidden h-8 w-auto" src="{{ asset('parrot.png') }}" alt="Workflow">
                            <img class="hidden lg:block h-8 w-auto" src="{{ asset('parrot.png') }}" alt="Workflow">
                        </h1>
                    </button>
                </div>
                ...
                <div class="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                    ...
                    <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Playlist</a>

                    <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Tracks</a>
